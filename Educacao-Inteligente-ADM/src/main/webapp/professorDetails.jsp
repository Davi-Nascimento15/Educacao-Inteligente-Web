        ...
        <div class="row col-md-12 pl-5 justify-content-md-center">
          <div class="col-md-auto">
            <ul class="nav mr-auto">
            	<h1 class="cabecario pl-5"> Detalhes do Professor </h1> 		
            </ul>
          </div>
        </div>  
      </div>
...
<form action="ControllerProfessor" method="post">
 ...
 <input type="hidden" name="ProfessorID" value="<%=ProfessorID %>">
  ...
  <div class="form-group row col-md-3 offset-md-1 pt-5">
    <label >Nome</label>
    <input type="text" class="form-control" aria-describedby="Nome" placeholder="Insira o nome" name= "nome" value="<%=professor.getNome()%>" readonly>
  </div>
  
  <div class="form-group row col-md-3 offset-md-1">
    <label >Endereço</label>
    <input type="text" class="form-control" aria-describedby="Endereco" placeholder="Insira o endereco" name= "endereco" value="<%=professor.getEndereco()%>" readonly>
  </div>
  
  <div class="form-group row col-md-3 offset-md-1">
    <label >Telefone</label>
    <input type="text" class="form-control" aria-describedby="Telefone" placeholder="Ex.: (XX)XXXXX-XXXX" name= "telefone" value="<%=professor.getTelefone()%>" readonly>
  </div>
  
  <div class="form-group row col-md-3 offset-md-1">
    <label >Email</label>
    <input type="email" class="form-control" aria-describedby="Email" placeholder="Ex.: user@gmail.com" name= "email" value="<%=professor.getEmail()%>" readonly>
  </div>
  
  <div class="form-group row col-md-3 offset-md-1">
    <label >Formação Acadêmica</label>
    <input type="text" class="form-control" aria-describedby="Formacao" placeholder="Insira a formacao" name= "formacao" value="<%=professor.getFormacao()%>" readonly>
  </div>
...
<%}%> 
  <div class="col-md-3 offset-md-1 pt-4 pb-5">
    <a href="professorcon.jsp" class="btn btn-danger">Voltar</a>
  </div>
<%} %>
 </form>
</body>
