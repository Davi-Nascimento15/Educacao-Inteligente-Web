        ...
        <div class="row col-md-12 pl-5 justify-content-md-center">
          <div class="col-md-auto">
            <ul class="nav mr-auto">
            	<h1 class="cabecario pl-5"> Detalhes da Notícia </h1> 		
            </ul>
          </div>
        </div>  
      </div>
...
<form action="ControllerNoticia" method="post">
  ...
  <div class="form-group row col-md-3 offset-md-1 pt-5">
    <label>Título</label>
    <input type="text" class="form-control" aria-describedby="Titulo" placeholder="Insira o titulo" name= "titulo" value="<%=noticia.getTitulo()%>" readonly>
  </div>
  
  <div class="form-group row col-md-8 offset-md-1 pt-3">
    <label for="exampleFormControlTextarea1">Descrição</label>
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="10" name= "descricao" readonly> <%=noticia.getDescricao()%> </textarea>
  </div> 
...
<%}%>  
  <div class="col-md-3 offset-md-1 pt-4 pb-5">
    <a href="noticiacon.jsp" class="btn btn-danger">Voltar</a>
  </div>
<%} %>
</form>
</body>
