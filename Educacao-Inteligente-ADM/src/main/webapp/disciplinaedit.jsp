        ...
        <div class="row col-md-12 pl-5 justify-content-md-center">
          <div class="col-md-auto">
            <ul class="nav mr-auto">
            	<h1 class="cabecario pl-5">Editar Disciplina </h1> 		
            </ul>
          </div>
        </div>  
      </div>
...
<form action="ControllerDisciplina" method="post">
	...
	<div class="form-group row col-md-3 offset-md-1 pt-5">
      <label >Nome</label>
       <input type="text" class="form-control" aria-describedby="Nome" placeholder="Insira o nome" name= "nome" value="<%=disciplina.getNome() %>" required>
    </div>
    
    <div class="form-group row col-md-3 offset-md-1">
      <label >Descrição</label>
       <input type="text" class="form-control" aria-describedby="Descricao" placeholder="Insira a descricao" name= "descricao" value="<%=disciplina.getDescricao() %>"  required>
    </div>
   ...
   <label>Escola</label>
	...
	<%
  	for(Escola E:ListaEscola){
  		if(E.getIdEscola()==disciplina.getEscola().getIdEscola()){
	%>
