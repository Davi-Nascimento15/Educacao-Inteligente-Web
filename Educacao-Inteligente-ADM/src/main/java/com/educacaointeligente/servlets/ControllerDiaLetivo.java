...
public class ControllerDiaLetivo extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("action").equals("del")) {
	    	int DiaLetivoId = Integer.parseInt(request.getParameter("IdDiaLetivo"));
	    	DiaLetivoDao diaLetivoDao = new DiaLetivoDao();
	    	DiaLetivo delDiaLetivo = diaLetivoDao.get(DiaLetivoId);
	    	diaLetivoDao.delete(delDiaLetivo);
	    	response.sendRedirect("dialetivocon.jsp?");
		}
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!(request.getParameter("IdDiaLetivo")==null)) {
